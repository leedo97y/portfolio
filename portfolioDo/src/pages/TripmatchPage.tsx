      ...
      <div className='flex flex-col gap-5 m-10 w-2/3'>
        <div className='flex flex-row items-center gap-4 mb-8'>
          <img
            src={tripmatch}
            alt='tripmatch logo'
            className='w-20 xxs:w-14 xxs:mr-2'
          />
          <div>
        ...
        <div className='flex flex-col gap-5 border-[0.5px] p-5'>
          ...
          <div>
            ...
            <a className='text-sky-600 xxs:text-xs'>
              {data?.project[3].repoUrl}
            </a>
          </div>
          <div>
            <p className=' font-bold text-base mb-1 xxs:text-xs'>WebSite. </p>
            <a
              className='text-sky-600 xxs:text-xs'
          ...
          <div>
            <p className=' font-bold text-base mb-1 xxs:text-xs'>Figma. </p>
            <a
              className='text-sky-600 xxs:text-xs'
        ...
        <div className='flex flex-col justify-center gap-5 border-[0.5px] p-5 mb-7'>
          ...
          <div className='xxs:text-xs'>{data?.project[3].stack.join(', ')}</div>
        </div>
